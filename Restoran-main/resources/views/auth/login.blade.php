...
<x-guest-layout>
    <div class="min-h-screen bg-cover bg-center bg-black bg-opacity-60" style="background-image: url('{{ asset('images/bg.jpg') }}');">
        <!-- Konten di sini -->
        <x-authentication-card>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center justify-end mt-4 gap-1">
                    <a class="underline me-4 text-sm text-yellow-500 hover:text-yellow-600 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500" href="{{ route('register') }}">
                    ...
                    <x-button class=" bg-yellow-500 hover:bg-yellow-600 focus:bg-yellow-600 active:bg-yellow-700 focus:ring-yellow-500 px-4 py-2 text-sm">
                        {{ __('Log in') }}
                    </x-button>
                </div>
